...
COLUMNS_MAGNET = ["FILE","DATE","TARGET","FOIL","CURRENT_MAX","CURRENT_MIN","CURRENT_AVE","CURRENT_STD","START_ISO","END_ISO","START_IRRADIATION","START_IRRADIATION_REL","DELTA_TIME"]
...
COLUMNS_FILLING = ["FILE","DATE","TARGET","RELATIVE_VOLUME","HIGH_PRESSURE_AVE","HIGH_PRESSURE_STD","LOW_PRESSURE_AVE","LOW_PRESSURE_STD","PRESSURE_IRRADIATION_AVE","PRESSURE_IRRADIATION_STD"]
